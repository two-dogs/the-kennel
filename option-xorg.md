...
***
ref: https://wiki.ubuntu.com/X/Config/Resolution & http://www.arachnoid.com/modelines/ & https://wiki.ubuntu.com/X/Config/Resolution#Adding_undetected_resolutions to **add resolutions not shown** on display options.
***
