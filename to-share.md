...
> if all else fails, [irc://spotchat.org/#pariah](irc://spotchat.org/#pariah) or http://spotchat.org/connect/ channel: #pariah , i am usually there or leave a message via '.tell two_dogs blah blah here is the gist  
